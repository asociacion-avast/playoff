...
| Script                 | Función                                                |
| ---------------------- | ------------------------------------------------------ |
| `0-download.py`        | Descarga la lista de socios y/o categorías             |
...
| `3-auditoria-integridad.py`                 | Audita la coherencia de socios, familias, actividades, inscripciones, recibos y sincronización, sin modificar datos |
...
| `3-listado-socios.py`                       | Listados unificados: actividad-familia, capfamilia, tutores                                                         |
...
| `4-auto-categoria.py`                       | Asigna categorías (año, +13/+15/+18) y borrar categorías no válidas. Incluye normalización de nombres y tutores     |
| `4-quita-asociado-activo-sin-pago.py`       | Quita la categoría de Asociado activo a los socios que la recibieron hoy y además tienen informe revisado           |
...
| `4-telegram.py`                             | Gestiona la vinculación de Telegram para socios y tutores (hereda de familiares, envía comunicados)                 |
...
| `7-telefons-google.py`                      | Genera un CSV con nombres y teléfonos móviles de socios y tutores para importar en Google Contacts                  |
